...
namespace Sneakerx_api.Controllers
{
    public class ServerController : Controller
    {
        ...
        public string GetCartAsync([FromBody]int userID)
        // 改了这里！！！！！！！
        // public List<CartInfo> GetCartAsync([FromBody]int userID)
        {
            cart.RemoveZero();
            cart.CartUpdate();
            logger.Trace("UserID: "+userID+" visit cart!");
            return JsonConvert.SerializeObject(cart.GetUserCart(userID));
            // 改了这里！！！！！
        ...
        public Double CheckOutAsync([FromBody]int userID)
        {
            ...
            string connString = "SERVER=db-final.mysql.database.azure.com" + ";" +
                                "DATABASE=FINAL;" +
                                "UID=wensongliu@db-final;" +
        ...
        public void BalanceUpdate([FromBody]User user)
        {
            ...
            logger.Trace("User: " + user.emailAddress + " update balance unsuccessfully!");
        }
        ...
        public List<OrderInfo> GetMyOrderAsync([FromBody]int userID)
        {
            ...
            logger.Trace("UserID: "+userID+" get all orders");
            return MyOrder;
        }
...
//<div class="content_box_photo">
            ...
            //    <div>
            //        <form[formGroup]="loginInfoForm" (ngSubmit)="onLogin(loginInfoForm.value)" class="form">
            //            <br />
            //            <br />
            //            <div>
            ...
            //            <br />
            //            <div>
            //                <button type = "submit" name="loginBtn" style="width:150px" class="enter">Log In</button>
            //              </div>
            //        </form>
            //    </div>
            //</div>
